let articleTypeButton = document.querySelector('.filter__link--selected');
...
articlesTypesContainer.addEventListener("click", (e) => {
    ...
    const isTypeSelected = articleType === typeValue;
    ...
    if (isTypeSelected) {
        ...
        type.classList.add("filter__link--selected");
        articleTypeButton.classList.remove("filter__link--selected");
